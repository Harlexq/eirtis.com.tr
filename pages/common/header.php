    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                <li class="nav-item <?php if (basename($_SERVER['PHP_SELF']) == 'index') echo 'active'; ?>">
                    <a class="nav-link hvrcenter" href="index">ANASAYFA</a>
                </li>
                <li class="nav-item <?php if (basename($_SERVER['PHP_SELF']) == 'sponsor') echo 'active'; ?>">
                    <a class="nav-link hvrcenter" href="sponsor">SPONSOR</a>
                </li>
                <li class="nav-item <?php if (basename($_SERVER['PHP_SELF']) == 'about') echo 'active'; ?>">
                    <a class="nav-link hvrcenter" href="about">HAKKIMIZDA</a>
                </li>
                <li class="nav-item <?php if (basename($_SERVER['PHP_SELF']) == 'commands') echo 'active'; ?>">
                    <a class="nav-link hvrcenter" href="commands">KOMUTLAR</a>
                </li>
                <li class="nav-item <?php if (basename($_SERVER['PHP_SELF']) == 'team') echo 'active'; ?>">
                    <a class="nav-link hvrcenter" href="team">EKİP</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle services <?php if (basename($_SERVER['PHP_SELF']) == 'bot' || basename($_SERVER['PHP_SELF']) == 'web' || basename($_SERVER['PHP_SELF']) == 'design') echo 'active'; ?>" role="button" data-bs-toggle="dropdown" href="services">SERVİSLER</a>
                ...
                <li class="nav-item <?php if (basename($_SERVER['PHP_SELF']) == 'contact') echo 'active'; ?>">
                    <a class="nav-link hvrcenter" href="contact">İLETİŞİM</a>
                </li>
            </ul>
            <ul class="navbar-nav navbar-button">
                <button class="bg-transparent bg-ds"><a class="nav-link text-ds" target="_blank" href="https://discord.gg/clydev">Destek Sunucusu</a></button>
